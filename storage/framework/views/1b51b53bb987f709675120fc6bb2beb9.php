...
<body>
    ...
    <div class="form-addopt">
        <form class="row g-3">
            <div class="col-12">
                <label for="inputDeliver" class="form-label">Nama Hewan Adopsi</label>
                <select id="inputDeliver" class="form-select">
                <option selected>Mimi</option>
                <option>Mola</option>
                <option>Milo</option>
                </select>
            </div>
...
</html><?php /**PATH D:\Chintya\KULIAH\SMT 6\PEMWEB\Project\petshelter\resources\views/request/addopt.blade.php ENDPATH**/ ?>